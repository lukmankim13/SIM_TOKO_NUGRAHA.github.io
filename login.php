...
<html lang="en">
  ...
  <body class="app flex-row align-items-center" style="background-image: url('assets/images/fototoko.jpg'); background-size: cover;">
    <div class="container">
        ...
        <div class="col-md-8">
          <div class="card-group">
            <div class="card p-4">
              ...
              <div class="card-body">
              <div>
						  <img src="assets/images/logo.png" alt="logo" style="width: 80%; margin-left: 30px">
				  	</div>
                <h2>Login</h2>
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
                <div>
                  ...
                  <p>Untuk Menggunakan Aplikasi Penjualan Anda Harus Login Terlebih Dahulu</p>
                </div>
              </div>
            </div>
          </div>
